...
export class AsignaturasAdminComponent implements OnInit, OnDestroy {
    ...
    goToShowSubject(asignatura) {
        this.router.navigateByUrl('/ver-asignatura', { state: { asignatura: asignatura } });
    }

    goToCreateMaterial(asginatura) {
        this.router.navigateByUrl('/material-asignatura', { state: { asignatura: asginatura } });
    }
